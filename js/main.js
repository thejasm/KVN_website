...
$(document).ready(function() {
  ...
  if($('ul#flickr-badge').length) {
    ...
    itemTemplate: '<li><div class="flickr-container"><a href="http://www.flickr.com/photos/56342020@N03"><span><picture><source srcSet="images/.avif" type="image/avif" /><img src="{{image_m}}" alt="{{title}}" /></span></a></div></li>'
    });
  };
