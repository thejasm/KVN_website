...
jQuery.extend(true,_R, {
	...
	startKenBurn :  function(l,opt,prgs) {			
		...
		if (l.find('.tp-kbimg').length==0) {
			l.append('<div class="tp-kbimg-wrap" style="z-index:2;width:100%;height:100%;top:0px;left:0px;position:absolute;"><picture><source srcSet="images/.avif" type="image/avif" /><img class="tp-kbimg" src="'+s+'" style="position:absolute;" width="'+d.owidth+'" height="'+d.oheight+'"></div>');
